...
import { createDndDslServices, isModel } from "dnd-dsl-language";*/

//let services: ReturnType<typeof createDndDslServices>;
//let parse:    ReturnType<typeof parseHelper<Model>>;
//let document: LangiumDocument<Model> | undefined;

beforeAll(async () => {
    //services = createDndDslServices(EmptyFileSystem);
    //const doParse = parseHelper<Model>(services.DndDsl);
