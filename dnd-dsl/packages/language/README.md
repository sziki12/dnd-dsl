...
- [src/dnd-dsl.langium](src/dnd-dsl.langium) -  The grammar definition of your language
- [src/dnd-dsl-module.ts](src/dnd-dsl-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/dnd-dsl-validator.ts](src/dnd-dsl-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/dnd-dsl.monarch.ts](src/syntaxes/dnd-dsl.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/dnd-dsl.tmLanguage.json](syntaxes/dnd-dsl.tmLanguage.json) - Textmate based syntax highlighting instructions.
